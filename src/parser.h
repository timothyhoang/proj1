...
typedef enum scope {global_var, global_func, local_var} scope;
...
/** Returns the number or arguments corresponding to the string STR, or -1 if no node_type 
 *  corresponds. */
...
extern smap *decls;
extern smap *all_decls;
extern smap *local_decls;
extern smap *structs;
